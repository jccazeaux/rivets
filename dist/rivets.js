...
(function() {
  ...
  Rivets.ComponentBinding = (function(_super) {
    ...
    ComponentBinding.prototype.bind = function() {
      var k, key, keypath, keyy, newScope, observer, option, options, scope, v, valuee, _base, _i, _j, _len, _len1, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      if (!this.bound) {
      ...
      if (this.componentView != null) {
        ...
        scope = Object.create(this.view.models);
        newScope = this.component.initialize.call(this, this.el, this.locals());
        for (keyy in newScope) {
          valuee = newScope[keyy];
          scope[keyy] = valuee;
        }
        this.el._bound = true;
        options = {};
